namespace BaiTapLon_ComputerStore.Reports
{
	partial class rptListEmployee
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rptListEmployee));
			...
			this.xrTableCell9.Weight = 0.05880175842033579D;
			// 
			// xrTableCell5
			// 
			this.xrTableCell5.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "ReportEmployees.ID_Emp")});
			this.xrTableCell5.Name = "xrTableCell5";
			this.xrTableCell5.StyleName = "DetailData3";
			this.xrTableCell5.StylePriority.UseTextAlignment = false;
			this.xrTableCell5.Text = "xrTableCell5";
			this.xrTableCell5.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell5.Weight = 0.18860949119555992D;
			// 
			// xrTableCell6
			// 
			this.xrTableCell6.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "ReportEmployees.Name_Emp")});
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.StyleName = "DetailData3";
			this.xrTableCell6.StylePriority.UseTextAlignment = false;
			this.xrTableCell6.Text = "xrTableCell6";
			this.xrTableCell6.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell6.Weight = 0.29784516886037921D;
			// 
			// xrTableCell7
			// 
			this.xrTableCell7.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "ReportEmployees.Quantily Product")});
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.StyleName = "DetailData3";
			this.xrTableCell7.StylePriority.UseTextAlignment = false;
			this.xrTableCell7.Text = "xrTableCell7";
			this.xrTableCell7.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell7.Weight = 0.14409265858975967D;
			// 
			// xrTableCell8
			// 
			this.xrTableCell8.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "ReportEmployees.Proceeds of Sold")});
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.StyleName = "DetailData3";
			this.xrTableCell8.StylePriority.UseTextAlignment = false;
			this.xrTableCell8.Text = "xrTableCell8";
			this.xrTableCell8.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell8.Weight = 0.3106509634164682D;
			// 
			// TopMargin
			// 
			...
			storedProcQuery1.Name = "ReportEmployees";
			...
			storedProcQuery1.StoredProcName = "ReportEmployees";
			...
			this.xrLabel1.Text = "List Employees";
			// 
			// groupHeaderBand1
			// 
			...
			this.xrTableCell10.Weight = 0.058801750769981981D;
			// 
			// xrTableCell1
			// 
			...
			this.xrTableCell1.Weight = 0.18860950176532448D;
			// 
			// xrTableCell2
			// 
			...
			this.xrTableCell2.Weight = 0.29784509512094348D;
			// 
			// xrTableCell3
			// 
			...
			this.xrTableCell3.Text = "Quantily Product";
			this.xrTableCell3.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell3.Weight = 0.14409268892728364D;
			// 
			// xrTableCell4
			// 
			...
			this.xrTableCell4.Text = "Proceeds of Sold";
			this.xrTableCell4.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
			this.xrTableCell4.Weight = 0.31065096341646631D;
			// 
			// Title
			// 
            ...
            this.sqlDataSource1});
			this.DataMember = "ReportEmployees";
